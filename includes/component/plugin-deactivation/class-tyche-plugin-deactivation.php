		...
		public function enqueue_scripts() {
			...
			$data = array(
				'reasons'  => array(
					array(
						'id'                => 1,
						'text'              => __( 'I only needed the plugin for a short period.', 'currency-per-product-for-woocommerce' ),
						'input_type'        => '',
						'input_placeholder' => '',
					),
					array(
						'id'                => 2,
						'text'              => __( 'I found a better plugin.', 'currency-per-product-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'Please let us have the plugin\'s name so that we can make improvements', 'currency-per-product-for-woocommerce' ),
					),
					array(
						'id'                => 3,
						'text'              => __( 'The plugin is not working.', 'currency-per-product-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'Please share what was faulty with the plugin so that we may get the issue fixed.', 'currency-per-product-for-woocommerce' ),
					),
					array(
						'id'                => 4,
						'text'              => __( 'The plugin is causing issues on my site', 'currency-per-product-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'We’re sorry! Please tell us about the issues so that we can get them fixed.', 'currency-per-product-for-woocommerce' ),
					),
					array(
						'id'                => 6,
						'text'              => __( 'Some features I need are not working as per my expectations', 'currency-per-product-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'Please tell us about these features.', 'currency-per-product-for-woocommerce' ),
					),
					array(
						'id'                => 7,
						'text'              => __( 'The plugin is not compatible with another plugin/theme', 'currency-per-product-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'We’re sorry! We would like you to tell us the plugin/theme so that we can work on the compatibility.', 'currency-per-product-for-woocommerce' ),
					),
					array(
						'id'                => 10,
						'text'              => __( 'Other', 'currency-per-product-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => '',
					),
				),
								...
								<div class="ts-modal-dialog">
									<div class="ts-modal-body">
										...
										<div class="ts-modal-panel active" data-panel-id="reasons">
											<h3>
												<strong>
													' . __( 'If you have a moment, please let us know why you are deactivating:', 'currency-per-product-for-woocommerce' ) . '
												</strong>
											</h3>
									...
									<div class="ts-modal-footer">
										<a href="javascript:void(0);" class="button button-secondary button-skip-deactivate"> ' . __( 'Skip & Deactivate', 'currency-per-product-for-woocommerce' ) . '</a>
										<a href="javascript:void(0);" class="button button-secondary button-deactivate"> ' . __( 'Submit & Deactivate', 'currency-per-product-for-woocommerce' ) . '</a>
										<a href="javascript:void(0);" class="button button-primary button-close">' . __( 'Cancel', 'currency-per-product-for-woocommerce' ) . '</a>
									</div>
								</div>
							</div>',
			);
			...
			wp_localize_script(
				...
				array(
					...
					'deactivation_req_msg' => __( 'Please select a reason for deactivation!', 'currency-per-product-for-woocommerce' ),
				)
			);
