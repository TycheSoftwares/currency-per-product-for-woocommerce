...
const PLUGIN_SLUG = "currency-per-product-for-woocommerce";
...
function patchWcVersion(dest) {
    ...
    const filesToRemove = [
        "includes/class-tyche-cpp-tracking.php",
        "includes/class-tyche-cpp-deactivation.php",
    ];
    ...
    // Remove includes/tyche/ folder (contains tracking, license, updater, deactivation components).
...
// Injects 'isWcVariant' => true into the wp_localize_script cppAdminData array
// in class-admin-scripts.php so the JS hides the License tab and Reset Tracking
// button at runtime.
